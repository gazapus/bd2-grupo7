...
// Test consulta 7
rankingDeClientesPorMonto(new Date(2020, 1) , new Date());    // cadena completa
rankingDeClientesPorMonto(new Date(2020, 1, 1) , new Date(), 1);    // sucursal 1
//rankingDeClientesPorMonto(new Date(2020, 1, 1) , new Date(), 2);    // sucursal 2
//rankingDeClientesPorMonto(new Date(2020, 1, 1) , new Date(), 3);    // sucursal 3